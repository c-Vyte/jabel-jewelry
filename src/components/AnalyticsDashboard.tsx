...
const COLORS = ['#000000', '#6B7280', '#D1D5DB', '#9CA3AF', '#F3F4F6'];
const STATUS_COLORS = {
  pending: '#F59E0B',
  confirmed: '#3B82F6',
  processing: '#8B5CF6',
...
export default function AnalyticsDashboard({ orders, products }: AnalyticsDashboardProps) {
  ...
  const conversionRate = 3.2; // Placeholder - would need session data
        ...
        <ChartCard title="Monthly Comparison (6 Months)" subtitle="Revenue vs Orders">
          <ResponsiveContainer width="100%" height={300}>
            <BarChart data={monthlyData} margin={{ top: 10, right: 30, left: 0, bottom: 0 }}>
              ...
              <Tooltip content={<CustomTooltip />} />
              <Legend />
              <Bar dataKey="revenue" name="Revenue (GH₵)" fill="#000000" radius={[4, 4, 0, 0]} />
