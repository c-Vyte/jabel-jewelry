...
export default function Home({ products, searchQuery, onAddToCart, initialCategory }: HomeProps) {
  ...
  const categories = ['Rings', 'Necklaces', 'Watches', 'Earrings', 'Accessories', 'Perfumes', 'Native African Materials'];
                  ...
                  <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 pt-4 border-t border-theme-border/50">
                    ...
                    <div className="flex items-center gap-3 w-full sm:w-auto">
                      ...
                      <a
                        ...
                        className="flex-1 sm:flex-none px-6 py-2 bg-theme-accent text-theme-accent-fg text-xs font-medium uppercase tracking-widest hover:opacity-90 transition-opacity text-center"
                      >
                        Details
                      </a>
                    </div>
